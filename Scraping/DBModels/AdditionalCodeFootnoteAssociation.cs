...
namespace Scraping.DBModels
{
    ...
    public class AdditionalCodeFootnoteAssociation
    {
        ...
        public AdditionalCodeFootnoteAssociation(ftnoteAssocAddCode obj, long AdditionalCode_hjid, string fileName = "")
        {
            hjid = obj.hjid;
        ...
        public void UpdateFields(ftnoteAssocAddCode obj, string fileName = "")
        {
            opType = obj.metainfo?.opType.ToString();
            origin = obj.metainfo?.origin.ToString();
            status = obj.metainfo?.status.ToString();
