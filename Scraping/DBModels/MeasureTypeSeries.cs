...
{
    [Table("MeasureTypeSeries")]
    public class MeasureTypeSeries
    {
        [Key]
        ...
        public string measureTypeCombination { get; set; }
        ...
        public MeasureTypeSeries()
        {
        }

        public MeasureTypeSeries(Scraping.MeasureTypeSeries obj, string fileName = "")
        {
            hjid = obj.hjid;
        ...
        public void UpdateFields(Scraping.MeasureTypeSeries obj, string fileName = "")
        {
            opType = obj.metainfo?.opType.ToString();
            origin = obj.metainfo?.origin.ToString();
            status = obj.metainfo?.status.ToString();
