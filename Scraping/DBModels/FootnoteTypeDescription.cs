...
{
    [Table("FootnoteTypeDescriptions")]
    public class FootnoteTypeDescription
    {
        [Key]
        ...
        public long footnoteType_hjid { get; set; }
        ...
        public FootnoteTypeDescription()
        {
        }

        public FootnoteTypeDescription(Description desc, long footNoteType_hjid, string fileName = "")
        {
            hjid = desc.hjid;
            footnoteType_hjid = footNoteType_hjid;
