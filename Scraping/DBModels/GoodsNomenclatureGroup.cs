...
{
    [Table("GoodsNomenclatureGroups")]
    public class GoodsNomenclatureGroup
    {
        [Key]
        ...
        public string goodsNomenclatureGroupId { get; set; }
        public string goodsNomenclatureGroupType { get; set; }
        ...
        public GoodsNomenclatureGroup(Scraping.GoodsNomenclatureGroupoodsNomenclatureGroup obj, string fileName = "")
        {
            ...
            goodsNomenclatureGroupId = obj.goodsNomenclatureGroupId;
            goodsNomenclatureGroupType = obj.goodsNomenclatureGroupType;
